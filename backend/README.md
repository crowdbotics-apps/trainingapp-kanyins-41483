...
## Project Structure
    ...
    ├── trainingapp_kanyins_41483  # Django project configurations
...
1. Clone this repo and `cd trainingapp_kanyins_41483`
...
2. Clone this repo and `cd trainingapp_kanyins_41483`
